...
class HardwareCryptoApi {
  /// Constructor for [HardwareCryptoApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  HardwareCryptoApi({BinaryMessenger? binaryMessenger})
  ...
  Future<bool> isSupported() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.hardware_crypto.HardwareCryptoApi.isSupported';
  ...
  Future<Uint8List> sign(String alias, Uint8List data) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.hardware_crypto.HardwareCryptoApi.sign';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[alias, data]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
