...
static void hardware_crypto_plugin_handle_method_call(
    HardwareCryptoPlugin* self,
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  HardwareCryptoPlugin* plugin = HARDWARE_CRYPTO_PLUGIN(user_data);
  hardware_crypto_plugin_handle_method_call(plugin, method_call);
}
